...
async def call_cmd_start(handler: Message, state: FSMContext, is_admin: bool):
    await cmd_start(handler, state, is_admin, user_cache)
...
# @main_router.callback_query(F.data == 'tutorial')
...
#
#
# @main_router.callback_query(F.data == 'tutorial_list')
...
#
#
# @main_router.message(Command('train'))
...
#
#
# @main_router.message(Command('marks'))
...
#
#
# @main_router.message(Command('rec'))
...
#
#
# @main_router.message(st.WrightBugsFSM.wright_bug)
