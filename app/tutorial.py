...
GENERAL_TUTORIAL = """ <b>ВИДЕОИНСТРУКЦИИ ПО ПОЛЬЗОВАНИЮ БОТОМ</b>\n
🔸общие сведения о боте <b><i>/gen</i></b>;\n
🔸порядок записи на тренировку <b><i>/sign</i></b>;\n
🔸как не попасть в конец очереди <b><i>/met</i></b>;\n\n

<b>ТЕКСТОВЫЕ ИНСТРУКЦИИ ПО ПОЛЬЗОВАНИЮ БОТОМ</b>\n
🔸порядок записи на тренировку <b><i>/train</i></b>;\n
🔸рекомендации, как не оказаться в конце очереди после записи на тренировку <b><i>/rec</i></b>;\n
🔸что означают маркеры (✅, ❌, ✔️) статуса в записи на тренировку <b><i>/marks</i></b>.
"""
