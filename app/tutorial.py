...
TUTORIAL = ("📋 <b>ОСНОВНЫЕ КОМАНДЫ</b>:\n"
            ...
            "\n\nРазработчик Саит Бахтеев, код бота можно посмотреть <a href='https://github.com/SaitBakhteev/Projects'>здесь</a>.")
...
MARKS_DESCRIPTION = ('Рядом с каждым учатником <i>из основного списка</i> ставится соответствующая метка, '
                     ...
                     '⚠️ участник не произвел оплату или в случае проведенной оплаты не оповестил бот нажатием кнопки <i>"✔️ Тренировка оплачена"</i>;\n'
