...
from config import bot, WEBHOOK_TOKEN, URL, REPER_HOURS, TORTOISE_ORM, season_index, setup_logger, setup_base_logger
...
async def startup(dispatcher: Dispatcher):
    try:
        ...
        # scheduler.add_job(check_payment_dedline, CronTrigger(hour=22, minute=14), id=f"scan_test", kwargs={'notify': False, 'bot': bot, 'user_cache':user_cache})
